...
function cssPrint() {
 /*  document.getElementById("submitBtn").style.display = "none";
  document.getElementById("updateValuesBtn").style.display = "none";*/
...
document.getElementById("workshopPara").innerText 
   ...
   switch (paragraph.id) {
    ...
    case 'placenamePara':
      ...
      case 'datePara':
         ...
         break;
      case 'workshopPara':
         paragraph.innerText = 'Workshop Initiated By: ' + workshopInput.value;
         break;
...
function updateContent() {
      ...
      document.getElementById("workshopPara").innerText = 'Workshop Initiated By: ' + workshopInput;
  }
